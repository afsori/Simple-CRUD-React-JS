...
class Forms extends Component {
  ...
  postVouchers() {
    ...
    // formData.append("location", this.state.vouchersDataPost.location);
    // formData.append("owner", this.state.vouchersDataPost.owner);
    // formData.append("room_type", this.state.vouchersDataPost.room_type);
    // formData.append("price", this.state.vouchersDataPost.price);

    // formData.append("description", this.state.vouchersDataPost.description);
    // formData.append("fasilitas", this.state.vouchersDataPost.fasilitas);
  ...
  updateTransactions(id) {
    axios
      .put(
        `http://192.168.6.122:9000/stay/edit/${this.state.transactionsDataUpdate.id}`
      )
      .then(() => {
        this.getStay();
