...
class Charts extends Component {
  ...
  getTransactions() {
    axios
      .get("https://clonedana.herokuapp.com/api/transactions")
      .then(res => {
        this.setState({
  ...
  removeTransactions(e) {
    axios
      .delete(
        `https://clonedana.herokuapp.com/api/transactions/${e.currentTarget.value}`
      )
      .then(() => {
  ...
  updateTransactions(e) {
    axios
      .put(
        `https://clonedana.herokuapp.com/api/transactions/${this.state.transactionsDataUpdate.id}`
      )
      .then(() => {
        this.getTransactions();
                      ...
                      <tr key={idx}>
                        ...
                        <td>
                          ...
                          <Button
                            ...
                            color="danger"
                            value={data.id}
                            onClick={this.removeTransactions}
                          >
                  ...
                  <FormGroup row>
                    ...
                    <Col xs="12" md="9">
                      <Input
                        ...
                        id="status"
                        name="status"
                        defaultValue={this.state.transactionsDataUpdate.status}
                      />
                    </Col>
                  </FormGroup>
                </Form>
