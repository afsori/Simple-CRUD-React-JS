...
class Forms extends Component {
  ...
  getVouchers() {
    axios
      .get("https://clonedana.herokuapp.com/api/vouchers")
      .then(res => {
        this.setState({
  ...
  postVouchers() {
    ...
    axios
      .post("https://clonedana.herokuapp.com/api/vouchers", formData, config)
      .then(() => {
        this.getVouchers();
      });
  }
  ...
  removeVouchers(e) {
    axios
      .delete(
        `https://clonedana.herokuapp.com/api/vouchers/${e.currentTarget.value}`
      )
      .then(() => {
        this.getVouchers();
      });
      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" sm="6">
            <Card>
              <CardHeader>
                <strong>Place to stay Forms</strong>
              </CardHeader>
              <CardBody>
                <Form encType="multipart/form-data" className="form-horizontal">
                  <FormGroup row>
                    <Col md="3">
                      <Label htmlFor="text-input">Place Name </Label>
                    </Col>
                    <Col xs="12" md="9">
                      <Input
                        type="text"
          ...
          <Col xs="12" lg="6">
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i> Place to stay Table
              </CardHeader>
              <CardBody>
                <Table responsive>
                  <thead>
